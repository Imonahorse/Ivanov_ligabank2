    ...
    <footer className={styles.footer}>
      <div className={`${styles.inner} container`}>
        ...
        <div className={styles.telHome}>
          <a className={styles.phone} href='tel:88001112233'>8 800 111 22 33</a>
          <span className={styles.description}>Бесплатный для всех городов России</span>
        </div>
        <ul className={styles.socials}>
          <li className={styles.icon}>
            <a href='/#' aria-label='Перейти в фейсбук'>
              <svg
                width='9'
                height='16'
                viewBox='0 0 9 16'
          ...
          <li className={styles.icon}>
            <a href='/#' aria-label='Перейти в инстаграм'>
              <svg
                width='16'
                height='16'
                viewBox='0 0 16 16'
          ...
          <li className={styles.icon}>
            <a href='/#' aria-label='Перейти в твиттер'>
              <svg
                width='16'
                height='13'
                viewBox='0 0 16 13'
          ...
          <li className={styles.icon}>
            <a href='/#' aria-label='Перейти в ютуб'>
              <svg
                width='16'
                height='13'
                viewBox='0 0 16 13'
