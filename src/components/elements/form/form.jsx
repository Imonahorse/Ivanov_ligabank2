      ...
      <ul>
        <li className={styles.item}>
          ...
          <label className={styles.label}>
            ...
            <input
              className={cn(styles.input, {[styles.input__error]: priceError})}
              type='text'
          ...
          <button
            ...
            className={cn(styles.control, styles.control__minus)}
          >
          </button>
          <button
            onClick={handleButtonClick}
            ...
            className={cn(styles.control, styles.control__plus)}
          >
          </button>
